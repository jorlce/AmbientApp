...
*/
    ...
    public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            TextView tsensorLabel;
            TextView tsensorLatitud;
            TextView tsensorLongitud;
            ...
            public void onClick(View view) {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    intent.putExtra("latitud", sensor.getLatitud());
                    intent.putExtra("longitud", sensor.getLongitud());
        ...
        public void onBindViewHolder(MyRecyclerAdapter.ViewHolder viewHolder, int position) {
            ...
            TextView mSensorLabel = viewHolder.tsensorLabel;
            mSensorLabel.setText(sensor.getSensorlabel());
            Log.d("MyRecyclerAdapte.onBind", sensor.getSensorlabel());
            TextView mSensorLat = viewHolder.tsensorLatitud;
            mSensorLabel.setText(String.valueOf(sensor.getLatitud()));
            Log.d("MyRecyclerAdapte.onBind", String.valueOf(sensor.getLatitud()));
            TextView mSensorLong = viewHolder.tsensorLongitud;
            mSensorLabel.setText(String.valueOf(sensor.getLongitud()));
